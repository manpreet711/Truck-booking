...
<html>
    ...
    <body style=" background: #cccccc;">
        ...
        <div class="w3-container" style="box-shadow: 0 0 20px 5px #1e649f inset, 0 0 10px 4px #1e649f; padding-left: 20px; padding-right: 20px;">
        <h1 align = "center"> Booking Offers </h1>
    <table   class="table table-striped table-dark table-hover">
           ...
           <?php while($row = mysqli_fetch_array($res))
           {
            ...
            <td><?php echo "<i class=\"fa fa-check\" onclick=\"location.href='offersp.php?id=$id&s=a'\" ></i>"
            ?></td>
            <td><?php echo "<i class=\"fa fa-times\" onclick=\"location.href='offersp.php?id=$id&s=r'\"></i>"
           ?></td>
           <?php } ?>
