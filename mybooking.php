...
<html>
    ...
    <table   class="table table-striped table-dark table-hover">
           ...
           <?php while($row = mysqli_fetch_array($res))
           {
            ...
            <td><?php if($row['status']==1) {echo "accepted";} elseif($row['status']==2) {echo"rejeced";} else{echo"pending";}
            ?></td>
           <?php } ?>
    </table>
    </div>
        <footer class="footer-area">
                <div class="footer-top section-padding" style="padding-top:60px; padding-bottom:60px;">
                    <div class="container">
                        <div class="row">
